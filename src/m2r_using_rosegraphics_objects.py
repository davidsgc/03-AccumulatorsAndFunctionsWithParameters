...
#        necessary?  Why?
#            When you are using multiple windows or need the window to close at a time the user chooses.
#            This is so the window closes when the user needs
#
